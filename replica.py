...
parser.add_argument('--dataset_base_path', type=str, default='/Users/lauragonzalez/PycharmProjects/TFM/', help='path to all the datasets in .txt format ')

parser.add_argument('--dataset', type=str, default='', help='name of the dataset in .txt format ')

parser.add_argument('--output_base_path', type=str, default='/Users/lauragonzalez/PycharmProjects/TFM/', help='result path')
